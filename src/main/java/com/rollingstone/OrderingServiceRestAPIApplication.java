...
@EnableSwagger2
public class OrderingServiceRestAPIApplication extends SpringBootServletInitializer {

    private static final Class<OrderingServiceRestAPIApplication> applicationClass = OrderingServiceRestAPIApplication.class;
